...
class AgricultureRAGChatbot:
    def __init__(self, use_llm=True):
        ...
        try:
            # Intent models
            self.intent_model = load_model('saved_state/intent_model.h5')
    ...
    def get_intent_based_fallback(self, intent, entities):
        ...
        fallbacks = {
            ...
            'Greeting': "Assalam-o-Alaikum! I am your Pakistan Agriculture RAG Assistant. How can I help you with your crops today?",
    ...
    def chat(self):
        ...
        print("\n" + "=" * 70)
        print("🌾🇵🇰  PAKISTAN AGRICULTURE RAG CHATBOT  🇵🇰🌾")
        print("=" * 70)
